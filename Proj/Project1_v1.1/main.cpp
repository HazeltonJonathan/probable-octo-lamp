 ...
 * Created on July 25, 2022, 12:45 PM
 * Purpose: C++ - Template to be used in all future Assignments
 */

/*
 * Version 1.1
 * Had to change if/else statements due to 11-14 not being assigned the
 * correct value. Added the card values to be displayed.
 */
